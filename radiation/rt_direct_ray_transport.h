...
{
    double c_light_eff=c_light_code_reduced(j,P,CellP), rsol_fac=c_light_eff/C_LIGHT_CODE, V_i_invphys=All.cf_a3inv/V_i, V_j_invphys=All.cf_a3inv/V_j, vfluid_minus_vface_dotA=0, cminusv_n_dotA[N_RT_INTENSITY_BINS]={0}, sigma_j=Particle_Size_j*(CellP[j].Density*All.cf_a3inv); int k_freq, k_angle;
